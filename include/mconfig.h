...
#define DEFAULT_TAP_HOLD 25
#define DEFAULT_TAP_DIST 400
#define DEFAULT_GESTURE_HOLD 10
#define DEFAULT_GESTURE_WAIT 300
#define DEFAULT_SCROLL_DIST 5
#define DEFAULT_SCROLL_UP_BTN 5
#define DEFAULT_SCROLL_DN_BTN 4
#define DEFAULT_SCROLL_LT_BTN 7
#define DEFAULT_SCROLL_RT_BTN 6
#define DEFAULT_SCROLL_HOLD 20
#define DEFAULT_SCROLL_COAST_MIN_SPEED 0.3
#define DEFAULT_SCROLL_COAST_DURATION 250
#define DEFAULT_SCROLL_COAST_TICK_MS 30 /* Schould be configurable? */
#define DEFAULT_SWIPE_DIST 0
#define DEFAULT_SWIPE_UP_BTN 1
#define DEFAULT_SWIPE_DN_BTN 1
#define DEFAULT_SWIPE_LT_BTN 1
#define DEFAULT_SWIPE_RT_BTN 1
#define DEFAULT_SWIPE_HOLD 0
...
#define DEFAULT_SWIPE_SENS 1000
#define DEFAULT_EDGE_SCROLL_DIST (DEFAULT_SCROLL_DIST*0.7)
#define DEFAULT_SCALE_DIST 150
#define DEFAULT_SCALE_UP_BTN 0
#define DEFAULT_SCALE_DN_BTN 0
#define DEFAULT_ROTATE_DIST 150
#define DEFAULT_ROTATE_LT_BTN 0
#define DEFAULT_ROTATE_RT_BTN 0
...
#define DEFAULT_SENSITIVITY 1.5
#define DEFAULT_ACC_SENSITIVITY 10
...
struct MConfig {
	...
	double acc_sensitivity; // acc scale, set as 0 to disable acc
